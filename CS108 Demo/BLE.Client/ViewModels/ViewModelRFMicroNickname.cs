...
namespace BLE.Client.ViewModels {
    ...
    public class ViewModelRFMicroNickname : BaseViewModel {
        ...
        public ViewModelRFMicroNickname(IAdapter adapter, IUserDialogs userDialogs) : base(adapter) { _userDialogs = userDialogs; }

        ~ViewModelRFMicroNickname() {}

        public override void Resume() { base.Resume(); }

        public override void Suspend() { base.Suspend(); }
