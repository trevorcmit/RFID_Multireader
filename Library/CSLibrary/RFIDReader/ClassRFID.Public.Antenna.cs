        ...
        public Result SetDefaultAntennaList() {
            ...
            switch (m_oem_machine) {
                ...
                default:
                    ...
                    // m_AntennaList.Add(new Antenna(1, AntennaPortState.ENABLED, 300, 2000, 0, false, false, SingulationAlgorithm.DYNAMICQ, 0, false, 0, false, 0, 1048575));
                    break;
